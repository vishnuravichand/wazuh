...
#define VU_DOWNLOAD_FAIL      "(5495): The download cannot be completed. Retrying in %d seconds."
...
#define VU_INS_MSU            "(5530): Inserting Microsoft Security Update dictionary."
...
#define VU_OSINFO_DISABLED    "(5544): Could not get the agent %s os_release, so its OS vulnerabilities will not be analyzed. It may not have os_info scan activated."
